...
from cmmr25_isudt.models.models import PlImgFactorVAE, PlSineFactorVAE, PlMapper
...
def main():
    ...
    # image model
    parser.add_argument('--img_model_ckpt_path', type=str, default='./ckpt/squares_vae/v21/v21_last_epoch=203.ckpt', help='image model checkpoint path')
    # audio model
    parser.add_argument('--audio_model_ckpt_path', type=str, default='./ckpt/sine_vae/v35/v35_last_epoch=1171.ckpt', help='sound model checkpoint path')
    # checkpoint & logging
    parser.add_argument('--ckpt_path', type=str, default='./ckpt/mapper', help='checkpoint path')
    parser.add_argument('--ckpt_name', type=str, default='v9', help='checkpoint name')
