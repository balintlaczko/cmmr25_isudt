...
def main():
    ...
    parser.add_argument("--f_min", type=float, default=72)
    parser.add_argument("--f_max", type=float, default=1176)
    ...
    parser.add_argument('--kld_weight_min', type=float, default=0.45, help='kld weight at the start of the warmup')
    ...
    parser.add_argument("--ckpt_name", type=str, default="v35")
